...
void TestScene::OnInitialize()
{
	...
	DeadlyObstacle1->SetTag(Tag::DEADLY_OBSTACLE);
	...
	RectangleEntity* pEntity6 = CreateRectEntity<RectangleEntity>(50, 500, sf::Color::White);
	pEntity6->SetPosition(100, 260);
...
void TestScene::OnUpdate()
{
	...
	for (Entity* entity : m_InstanceGameManager->GetEntities<Entity>()) // Parcours des entit�s du gameManager
	{
		...
		if (entity->IsTag(Tag::DEADLY_OBSTACLE))
		{
